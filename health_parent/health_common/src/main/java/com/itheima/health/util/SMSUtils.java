...
public class SMSUtils {
    public static final String VALIDATE_CODE = "SMS_205124512";//发送短信验证码模板编码  模版CODE
    ...
    public static void main(String[] args) throws ClientException {
        SMSUtils.sendShortMessage(VALIDATE_CODE, PHONE_NUMBER, VERIFICATION_CODE);
    }
    ...
    public static void sendShortMessage(String templateCode, String phoneNumbers, String param) throws ClientException {
        ...
        // 替换成你的AK
        final String accessKeyId = ACCESS_KEY;// accessKeyId
        final String accessKeySecret = SECRET_KEY;// accessKeySecret
