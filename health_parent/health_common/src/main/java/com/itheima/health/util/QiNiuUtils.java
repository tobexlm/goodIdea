...
public class QiNiuUtils {
    public static final String DOMAIN = "http://qiqhuoc4l.hn-bkt.clouddn.com//";
    private static final String ACCESSKEY = "8Dadr9CZ-AdE_c6U2WTv6jaWPRTcHNJgQ93F3IVP";
    private static final String SECRETKEY = "-lXv82HEnS12Zmf1JzVqMFkBYgHASHhuzBEmvcho";
    private static final String BUCKET = "szhm102";

    public static void main(String[] args) {
        // 上传(路径,保存文件名)
        //uploadFile("C:\\Users\\sco-tobeX\\Pictures\\北极光星空夜景4k风景壁纸3840x2160_彼岸图网.jpg","bjx4k.jpg");

        // 批量删除(文件名列表)
        //removeFiles("bjx4k.jpg");
